...
<div class="card-light p-3 flex items-center gap-3 hover:-translate-y-0.5 hover:shadow-lg transition">
    <a href="{{ route('directory.show', $business) }}" class="shrink-0">
        <x-business-cover :business="$business" class="w-12 h-12 rounded-2xl" size="sm"/>
    </a>
    <a href="{{ route('directory.show', $business) }}" class="flex-1 min-w-0">
        <div class="flex items-center gap-1.5">
            ...
            @if($business->isPromoted())
                <span class="text-honey-700 shrink-0" title="مُروَّج">⭐</span>
            @endif
