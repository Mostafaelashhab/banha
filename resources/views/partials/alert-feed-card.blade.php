...
<a href="{{ route('alerts.show', $alert) }}" class="card-light p-0 mb-3 overflow-hidden block hover:-translate-y-0.5 hover:shadow-lg transition relative">
    {{-- Top banner --}}
