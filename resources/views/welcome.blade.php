    ...
    <section id="voices" class="py-24 md:py-32 bg-cream-50">
        <div class="mx-auto max-w-6xl px-5">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                @php
                    $voices = [
                        ['أحمد · طالب هندسة',     'بقيت أعرف أسعار البقالة قبل ما أنزل من البيت. توفير وقت ولا أحلى.', 'A', '#FF7A4D'],
                        ['نورا · صيدلانية',       'الكونفيشن وول حاجة جنان. نص مدينة بنها بتحكي قصصها هناك.',           'N', '#1FA857'],
                        ['محمد · سواق توك توك',   'تنبيهات الزحمة وفرت لي ٤٠ دقيقة في يومي. عمري ما هرجع زي الأول.',   'M', '#FFB85C'],
                    ];
                @endphp
